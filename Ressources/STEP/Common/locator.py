...
Research = "xpath=//*[@class='gwt-SuggestBox stb-SuggestField stibo-Value']"
IconResearch = "xpath=//*[@class='gwt-SuggestBox stb-SuggestField stibo-Value']/following-sibling::node()"
...
loc_email_input = ("xpath=//div[@title='Email']/ancestor::div[contains(@class,"
                   ...
                   "@class='input-cell']")
loc_continuer = ("xpath=//div[contains(@class,'dialogMiddleCenterInner dialogContent')]/descendant::div[("
                 "@class='portal-alert-buttons')]")

##consent infos
loc_consent_first = ("xpath=//div[@title='Consent Info']/ancestor::div[@class='labelColumn labelColumn--direct-input "
                     "component-1']/following-sibling::div[@class='widgetColumn']/descendant::div["
                     "@class='DataContainerSubContainer'][1]")

all_consent = ("//div[@title='Consent Info']/ancestor::div[@class='labelColumn labelColumn--direct-input "
               "component-1']/following-sibling::div[@class='widgetColumn']/descendant::div["
